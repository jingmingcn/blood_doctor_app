...
import 'package:doctor/exceptions/secure_storage_exceptions.dart';
import 'package:doctor/model/user_model.dart';
import 'package:doctor/services/helper_service.dart';

import 'package:doctor/services/secure_storage_service.dart';

class AuthService {
  static const String loginPath = 'api/auth/signin';
  static const String registerPath = 'api/auth/signup';
